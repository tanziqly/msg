...
import strategyImage from "@/public/services/strategy-consulting.jpg"
import medtechImage from "@/public/services/medtech-digital.jpg"
...
const services = [
  ...
  },
  {
    ...
    img: strategyImage, // ← локальная картинка (Unsplash был недоступен/таймаутил)
    metric: "14+",
  ...
  },
  {
    ...
    img: medtechImage, // ← локальная картинка (Unsplash был недоступен/таймаутил)
    metric: "CAGR 23%+",
